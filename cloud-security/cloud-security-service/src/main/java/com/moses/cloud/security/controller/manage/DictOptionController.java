...
@Api(tags="选项级字典管理")
@RestController
@RequestMapping("/mapi/system/optdict")
public class DictOptionController {
	...
	public ResponseData<IPage<Dict>> pageByCondition(@Valid @RequestBody QueryDictForm form, BindingResult result){
		...
		IPage<Dict> dictIPage=dictService.pageByCondition(form);
		return ResponseData.<IPage<Dict>>builder().success().data(dictIPage).build();
	}
	...
	public ResponseData<String> updateType(@RequestBody UpdateDisabledForm form){
