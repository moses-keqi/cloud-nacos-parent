...
public class DelegatingSubject implements Subject {
    ...
    private static final String RUN_AS_PRINCIPALS_SESSION_KEY =
            org.apache.shiro.subject.support.DelegatingSubject.class.getName() + ".RUN_AS_PRINCIPALS_SESSION_KEY";
    ...
    public void login(AuthenticationToken token) throws AuthenticationException {
        ...
        if (subject instanceof org.apache.shiro.subject.support.DelegatingSubject) {
            org.apache.shiro.subject.support.DelegatingSubject delegating = (org.apache.shiro.subject.support.DelegatingSubject) subject;
    ...
    private class StoppingAwareProxiedSession extends ProxiedSession {
        ...
        private StoppingAwareProxiedSession(Session target, org.apache.shiro.subject.support.DelegatingSubject owningSubject) {
            super(target);
            owner = owningSubject;
        }
